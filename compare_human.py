...
#
evolved_dir = app_dir + os.path.join("New Paper", "Section 4.3", 
  "Layer 4 Mutualism")
#
# the path for the analysis report file
#
text_path = app_dir + os.path.join("New Paper", "Section 4.3",
  "compare_human_" + version + ".txt")
#
# the path for the spreadsheet file (tsv - tab separated values)
#
spreadsheet_path = app_dir + os.path.join("New Paper", "Section 4.3",
