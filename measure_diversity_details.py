...
f.write("\n\nLog File for Diversity Report\n\n")
f.write("generation number\trun number\tavg seed diversity\n")
#
...
for run in range(1, num_runs + 1):
    ...
    #
    avg_seed_diversity = mean(seed_diversity)
    #
    # Report the statistics for the given generation.
    #
    f.write("{:5d}\t{:5d}\t{:8.2f}\n".format( \
        generation_num, run, avg_seed_diversity))
    #
#
# Close file.
#
